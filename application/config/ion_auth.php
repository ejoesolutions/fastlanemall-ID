...
$config['tables']['users_profile']		= 'ci_users_profile';
$config['tables']['ci_seller']				= 'ci_seller';
 ...
 */
$config['site_title']                 = "fastlanemall.com";       // Site Title, example.com
$config['admin_email']                = "donotreply@fastlanemall.com"; // Admin Email, admin@example.com
...
$config['forgot_password_expiration'] = 0;                   /* The number of seconds after which a forgot password request will expire.
