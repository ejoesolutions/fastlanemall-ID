...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>COFFEE-FASTLANE.COM - SALES REPORT</title>
            ...
            <tr>
              <td colspan="4" align="center"> -->
                <table width="100%">
                 ...
                 <tr>
                  <?php
                  echo "<td align='center'><h5>Sales Report ".$b." ".$t."</h5></td>";
                   ?>
                </tr>
                </table>
                <br>
                  ...
                  <tbody>
                    ...
                    if(!empty($all_report)){
                      ...
                      //print_r($new_arr_sale);
                        ...
                        foreach ($new_arr_sale as $key) {
                          ...
                          <tr>
                            ...
                            foreach ($arr_sale as $k) {
                              if($key==$k['shop_name'])
                              {
                                echo number_format($k['net_total_sale'],2).'<br><br>';
                              }

                              if($user_profile['user_group']==2){
                                if($shop['seller_id']==$k['seller_id']){
                                  $total_grand+=$k['net_total_sale'];
                                }
                              }else{
                                $total_grand+=$k['net_total_sale'];
                              }
                        ...
                        //       if($k['order_status']==4 && $k['seller_id']==$shop['seller_id']){
                     ...
                     ?>
                     <!-- <tr>
                       <td colspan="7" align="right"><b>Total shipping = Rp <?php echo number_format($t_ship,2) ?></b></td>
                     </tr> -->
                     <tr>
                       <td colspan="7" align="right"><b>Total sales = Rp <?php echo number_format($total_grand,2) ?></b></td>
                     </tr>
                  </tbody>
              </table>
        </div>
